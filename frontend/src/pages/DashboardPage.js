...
<head>
  ...
  <style>
    body{font-family:'Segoe UI',Arial,sans-serif;max-width:580px;margin:40px auto;color:#2d3748;background:#f7fafc;}
    ...
    .header h1{margin:0;font-size:1.6rem;} .header p{margin:.3rem 0 0;opacity:.8;font-size:.9rem;}
    .badge{display:inline-block;background:#48bb78;color:white;padding:.4rem 1.2rem;border-radius:20px;font-weight:700;margin-top:.8rem;font-size:.9rem;}
    .body{padding:1.8rem 2rem;}
    .row{display:flex;justify-content:space-between;align-items:center;padding:.65rem 0;border-bottom:1px solid #f0f0f0;font-size:.92rem;}
    .row:last-child{border-bottom:none;}
    .label{color:#718096;} .value{font-weight:700;color:#1e3a5f;}
    .amount-row{background:#f0fff4;border-radius:10px;padding:1rem 1.2rem;margin:1rem 0;display:flex;justify-content:space-between;align-items:center;}
    .amount-label{color:#276749;font-weight:600;} .amount-value{font-size:1.6rem;font-weight:900;color:#276749;}
    .footer{background:#f7fafc;padding:1rem 2rem;text-align:center;color:#a0aec0;font-size:.78rem;border-top:1px solid #e2e8f0;}
    .watermark{color:#e2e8f0;font-size:3rem;text-align:center;margin:1rem 0;letter-spacing:4px;}
  </style>
</head>
<body>
<div class="card">
  ...
  <div class="body">
    ...
    <div class="row"><span class="label">Transaction ID</span><span class="value" style="font-size:.8rem">${txnId}</span></div>
  ...
  <div class="footer">Auto-generated by RideShield · Zero-touch insurance payout · Keep this for your records ❤️</div>
</div>
</body>
</html>`;
  ...
  a.href     = url;
  a.download = `RideShield_Payout_${txnId || Date.now()}.html`;
  a.click();
